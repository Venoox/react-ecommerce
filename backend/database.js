...
module.exports = () => {
	mongoose.connect(`mongodb://localhost:27017/webstore?retryWrites=true&w=majority`, { useNewUrlParser: true, useUnifiedTopology: true, useCreateIndex: true, useFindAndModify: false }, () => {
